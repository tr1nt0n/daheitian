...
trinton.make_music(
    ...
    evans.PitchHandler(
        [
            [
                evans.JIPitch(
                    fundamental="fs", ratio="253/128", with_quarter_tones=True
                ),
                evans.JIPitch(fundamental="fs", ratio="3/2", with_quarter_tones=True),
            ]
        ]
    ),
...
trinton.make_music(
    ...
    trinton.linear_attachment_command(
        ...
        selector=trinton.select_leaves_by_index([0, 0, 0, 21, 21, -1]),
    ),
    abjad.beam,
    trinton.notehead_bracket_command(),
...
trinton.make_music(
    ...
    evans.RhythmHandler(evans.talea([5, 1], 4)),
        ...
        attachments=[
            abjad.LilyPondLiteral(
                [
                    ...
                    r"\override Voice.RepeatTie.stencil = ##f",
            ...
            abjad.LilyPondLiteral(
                [
                    ...
                    r"\revert Voice.RepeatTie.stencil",
...
trinton.make_music(
    ...
    trinton.attachment_command(
        attachments=[
            abjad.LilyPondLiteral(
                r"\once \override TupletBracket.padding = -2.5", "before"
            )
        ],
...
trinton.make_music(
    ...
    library.tutti(selector=trinton.select_leaves_by_index([0])),
    trinton.attachment_command(
...
for voice_name, measure_pair in zip(
    ["bassclarinet voice", "bassoon voice"], [(1, 5), (1, 11)]
):
    trinton.make_music(
...
for voice_name in [
    ...
    trinton.make_music(
        ...
        rmakers.force_rest,
        trinton.force_note(
            selector=library._klavierubung_selectors[2]["bassoon voice"]
        ),
        trinton.treat_tuplets(),
        evans.RewriteMeterCommand(boundary_depth=-2),
        trinton.respell_tuplets_command(rewrite_brackets=False),
...
trinton.make_music(
    lambda _: trinton.select_target(_, (19, 26)),
    trinton.linear_attachment_command(
        attachments=[
            abjad.LilyPondLiteral(
                r"\override Staff.MultiMeasureRest.transparent = ##t", site="before"
...
trinton.make_music(
    ...
    library.change_lines(lines=5, clef="treble"),
    trinton.glissando_command(
        selector=trinton.ranged_selector(ranges=[range(0, 11)], nested=True),
        no_ties=True,
    ),
    trinton.linear_attachment_command(
        attachments=[abjad.StartHairpin("o<"), abjad.StopHairpin()],
    ...
    library.cue_eraser(),
    voice=score["violin 1 voice cue"],
    beam_meter=True,
)
...
for voice_name, measures in zip(
    [
        "bassclarinet voice secondary",
        "bassclarinet voice",
        "bassoon voice secondary",
        "bassoon voice",
        "piano 2 voice",
        "percussion 3 voice",
    ],
