...
trinton.make_music(
    ...
    library.tutti(
        selector=trinton.select_logical_ties_by_index(
            [16], first=True, grace=False, pitched=True
        )
    ),
...
trinton.make_music(
    ...
    evans.PitchHandler([0, 0, 0, -3, -3, -3, -3, -3]),
    library.change_lines(lines=1, clef="percussion"),
...
for voice_name in [
    ...
    trinton.make_music(
        ...
        library.einsatz(
            following_text="Gongs der chinesische Oper",
...
library.line_break(score=score, measure_range=(20,), break_method="break")
...
trinton.whiteout_empty_staves(
    score=score,
    cutaway="blank",
    voice_names=[_ for _ in library.all_voice_names if _ != "percussion 2 voice"],
)

library.blank_measure_by_hand(
    score=score,
    voice_names=["percussion 2 voice"],
    measures=[
        1,
        2,
        3,
...
library.blank_measure_by_hand(
    score=score,
    voice_names=["flute voice", "frenchhorn voice"],
    measures=[
        9,
    ],
)
