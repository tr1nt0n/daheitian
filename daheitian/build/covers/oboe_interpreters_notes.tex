...
\begin{center}
\includegraphics[scale=0.35]{vibrato.png}
\end{center}
\endgroup
...
\textbf{\circled{9}} Die in diesem Stück verwendeten \textbf{gleichschwebenden Intervalle} sind \textbf{Halbtöne}, und \textbf{Vierteltöne}. Ihre Symbole lauten wie folgt:
\endgroup
