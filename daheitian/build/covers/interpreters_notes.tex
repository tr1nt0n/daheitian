...
\begingroup
\begin{center}
\huge HINWEISE FÜR DIE INTERPRETEN:INNEN
\end{center}
\endgroup
...
\begingroup
muss \textbf{nicht die gesamte Orchestergruppe genau unisono interpretieren.} Vielmehr ist eine Variation der freien Parameters von Individuum zu Individuum erwünscht. \textbf{\circled{8} Fermaten} und ihre Längen sind wie folgt zu interpretieren:
\endgroup
...
\begingroup
\textbf{Klavier: \circled{1} Plusartikulationen} bedeuten, dass die betreffenden Saiten im Inneren des Klaviers mit dem linken Arm gedämpft werden, während man die Tasten spielt.
\endgroup

\begingroup
\textbf{Harfe: \circled{1}} Mit Ausnahme des Es, das bei Takt 176 benötigt wird, ist die Harfe immer auf \textbf{A, B, C, Dis, E, Fis} und \textbf{G} gestimmt. \textbf{\circled{2}} Der:die Harfenspieler:in sollte mit einer \textbf{Plastikkarte} und einen \textbf{kleinen Stimmgabel in G} ausgestattet sein.
\endgroup

\begingroup
\textbf{Pauken: \circled{1}} Der:die Pauker:in sollte mit einer \textbf{dünnen Metallkette} ausgestattet sein, die er:sie bei Bedarf über die Pauke legen kann.
\endgroup
...
\textbf{\circled{2} Die Instrumente} und ihre \textbf{Werkzeug} des \textbf{zweiter} Schlagzeuger:in sind so: \\
