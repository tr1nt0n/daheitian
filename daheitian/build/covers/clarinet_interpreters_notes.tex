...
\begingroup
\textbf{Fagotte: \circled{1}}  ( \textit{Dieser Punkt ist für dieses Instrument nicht relevant, wurde aber aus Gründen der numerischen Konsistenz beibehalten.} ) \textbf{\circled{2} Wenn keine erste Bassklarinette zur Verfügung steht}, übernimmt der \textbf{erste Fagottist} diese Stimme. 
\endgroup
