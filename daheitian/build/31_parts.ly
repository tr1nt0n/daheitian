                    ...
                    <<
                        \tag #'voice12
                        {
                            \context Staff = "harp 1 staff"
                            {
                                ...
                                %%% - \abjad-solid-line-with-hook
                                      %! +SCORE
                                %%% - \tweak bound-details.left.text \markup \concat { \override #'(font-name . "Bodoni72 Book") \override #'(style . "box") \override #'(box-padding . 0.5) \whiteout \box \fontsize #1 \line { Mit einem Triangelschläger zwischen den Saiten } \hspace #0.5 }
                                      %! +SCORE
                                ...
                                %%% \repeatTie
                                    ...
                                    R1 * 1/4
                                      %! +SCORE
                                %%% ^ \markup { \override #'(font-name . "Bodoni72 Book Italic") { \hspace #50 \right-column { \line { Providence, RI. \hspace #0.75 – \hspace #0.75 Leipzig, DE. } \line { November 2022 \hspace #0.75 – \hspace #0.75 March 2024. } } } }
                                }
                            }
                        }
                        \tag #'voice13
                        ...
                        \tag #'voice25
                        {
                            \context Staff = "contrabass staff"
                            {
                                ...
                                %%% \stopStaff \startStaff
                                    ...
                                    - \tweak padding #11
                                    - \abjad-solid-line-with-hook
                                    - \tweak bound-details.left.text \markup \concat { \override #'(font-name . "Bodoni72 Book") \override #'(style . "box") \override #'(box-padding . 0.5) \whiteout \box \fontsize #1 \line { DP } \hspace #0.5 }
                                    - \tweak bound-details.right.padding -2
                                    \startTextSpanOne
                                      %! +SCORE
                                %%% - \tweak padding #8
